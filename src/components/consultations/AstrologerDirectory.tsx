                    ...
                    <article key={a.id} className={`${styles.card} sacred-card`}>
                        <div className={styles.top}>
                            <h3 className={styles.name}>
                                {a.displayName}
                                {/* Disclosure, not decoration. Presenting an AI
                                    persona as a person is deceptive, and both
                                    stores treat it as grounds for rejection. */}
                                {a.isAI && (
                                    <span className={styles.aiTag} title="Replies are generated by AI">
                                        AI
                                    </span>
                                )}
                            </h3>
